...
let s:lighter_black   = { "gui": "#4E4E4E", "cterm": "240"  }
let s:medium_gray     = { "gui": "#767676", "cterm": "246"  }
...
call s:h("IncSearch",     {"bg": s:yellow, "fg": s:subtle_black})
call s:h("Search",        {"bg": s:dark_yellow, "fg": s:subtle_black})
